...
public class Player {
    ...
    public int rollDice(JLabel die1, JLabel die2){
        ...
        myDiceSet[1] = Integer.parseInt("" + die1.getIcon().toString().charAt(die1.getIcon().toString().length() - 5));
        myDiceSet[2] = Integer.parseInt("" + die2.getIcon().toString().charAt(die2.getIcon().toString().length() - 5));
     ...
     * If a single 1 is rolled, the score for the current turn is lost
    ...
    public boolean isTurnScoreLost(){
        ...
        if(myDiceSet[1] == 1 || myDiceSet[2] == 1) {
     ...
     * in the game, false otherwise. If two ones are rolled, the score for the entire game is lost
     * (i.e., it is set to zero) and the turn ends.
     *
    ...
    /**
     * This returns the current turn score.
     *
